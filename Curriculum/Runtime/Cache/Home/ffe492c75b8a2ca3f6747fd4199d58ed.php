...
<head>
		...
		<link href="/curriculum/Public/css/jq22.css" rel="stylesheet">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>登录-选课系统</title>
		<!-- 样式表文件 -->
		</head>
...
<div class="wrapper">
        <div class="login">
            <form action="<?php echo U('checklogin');?>" method="post" class="container offset1 loginform">
                <div id="owl-login">
                    <div class="hand"></div>
                ...
                <div class="form-actions">
                    <button type="submit" tabindex="4" class="btn btn-default btn-block">登录</button>
                </div>
            </form>
        </div>
    </div>
